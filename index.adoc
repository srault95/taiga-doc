...
You can create custom themes for Taiga.

To create a theme you have to create a new folder in `/app/themes/` with your theme name, then create two files inside.

`variables.scss` - to override variable for layout, fonts or colors.

`custom.scss` - to override any defined Taiga style.
